...
class DataIngestion:
    ...
    def initate_data_ingestion(self) -> Path:
        ...
        logging.info(f"Entered initiate_data__ingestion method of data_integration class")
        ...
        try:
            ...
            logging.info("exited initate_data_ingestion method of data_ingestion class")
